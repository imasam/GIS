...
static const char qt_meta_stringdata_QgsTextAnnotationDialog[] = {
    "QgsTextAnnotationDialog\0\0applyTextToItem()\0"
    "saveQuit()\0deleteItem()\0"
};
...
const QMetaObjectExtraData QgsTextAnnotationDialog::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QgsTextAnnotationDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_QgsTextAnnotationDialog,
      qt_meta_data_QgsTextAnnotationDialog, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QgsTextAnnotationDialog::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QgsTextAnnotationDialog))
        return static_cast<void*>(const_cast< QgsTextAnnotationDialog*>(this));
